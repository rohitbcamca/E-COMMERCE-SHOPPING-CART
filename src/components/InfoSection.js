...
import { FaTag,FaHeadset, FaLock, FaMoneyBill, FaShippingFast } from 'react-icons/fa'
...
const InfoSection= ()=>{
    ...
    return(
        <div className="bg-white pb-8 pt-12">
            <div className="container mx-aoto grid grid-cols-1 md:grid-cols-2 lg:grid-cols-5 gap-4">
