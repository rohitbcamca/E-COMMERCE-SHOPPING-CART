...
const Cart = ()=>{
    ...
    const [address,setAddress]=React.useState('main street,824103')
    ...
    return(
         ...
         <div>
            {cart.products.length > 0 ?
               <div> 
                      <h3  className="text-2xl fon-semibold mb-4 item-center ">SHOPPING CART</h3>
                           ...
                           <div className="flex justify-between border-b items-center mb-4 text-xs font-bold">
                              <p> PRODUCTS</p> 
                               ...
                               <div className="flex space-x-8 ">
                                    ...
                                    <div className="md:w-1/3 bg-white p-6 mb-6 rounded-lg shadow-md border" >
